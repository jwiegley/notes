...
export PKG_CONFIG_PATH=/usr/local/lib/pkgconfig:/usr/local/opt/gnutls/lib/pkgconfig:/usr/local/opt/libxml2/lib/pkgconfig:/usr/local/opt/freetype/lib/pkgconfig:/usr/local/opt/jpeg/lib/pkgconfig:/usr/local/opt/libtiff/lib/pkgconfig:/usr/local/opt/giflib/lib/pkgconfig:/usr/local/opt/libpng/lib/pkgconfig:/usr/local/opt/librsvg/lib/pkgconfig:/usr/local/opt/imagemagick/lib/pkgconfig:/opt/X11/lib/pkgconfig
