...
haskellPackages_ghc782 =
  ...
  in pkgs.recurseIntoAttrs (pkgs.haskellPackages_ghc782.override {
      extraPrefs = self: {
        ...
        #conduit            = callPackage /Users/johnw/Projects/conduit/conduit {};
        #conduitCombinators = callPackage /Users/johnw/Projects/conduit-combinators {};
...
localHoogle_ghc782 = pkgs.callPackage /Users/johnw/src/local-hoogle {
  ghc      = ghc.ghc782;
...
ghcEnv_782_buildInputs = with pkgs; [ 
  stdenv
  ghc.ghc782
  localHoogle_ghc782
] ++ myPackages
...
ghcEnv_782 = pkgs.myEnvFun {
    name = "ghc782";
    buildInputs = ghcEnv_782_buildInputs;
};
...
localHoogle_ghc763 = pkgs.callPackage /Users/johnw/src/local-hoogle  {
  ghc      = ghc.ghc763;
  hoogle   = haskellPackages.hoogleFork;
