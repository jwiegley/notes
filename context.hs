...
getF (ContextF g) = undefined

modifyF :: (c -> c) -> ContextF c d b -> a
modifyF f (ContextF g) = undefined

experimentF :: [c -> c] -> ContextF c d b -> [a]
experimentF fs w = undefined

liftCtxF :: (a -> b) -> ContextF c d b -> b
liftCtxF f (ContextF g) = undefined
